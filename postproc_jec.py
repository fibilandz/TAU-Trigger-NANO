...
from selectionFilter_jec import *
from tupleProducer_jec import *
...
def main():
    ...
    if isMC:
        ...
        if era == '2016':
            ...
            lumisToProcess = cms.untracked.VLuminosityBlockRange( LumiList.LumiList(filename="/afs/cern.ch/work/f/fbilandz/CMSSW_14_1_0_pre4/src/PhysicsTools/NanoAODTools/TAU-Trigger-NANO/Cert_Collisions2024_378981_386951_Golden.json").getCMSSWString().split(',') )
        else:
            raise RuntimeError("Please check the right Year!")
