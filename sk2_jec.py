...
# df = df.Define("prob_jet_idx","SelectJet(Jet_pt, Jet_eta)")\
#        .Filter("prob_jet_idx != -1")
...
df = df.Define("muon_p4", "Obj_p4(sig_muon_idx, Muon_pt, Muon_eta, Muon_phi, Muon_mass)")
df = df.Define("tau_p4", "Obj_p4(probe_tau_idx, Tau_pt, Tau_eta, Tau_phi, Tau_mass)")

df = df.Define("probe_jet_idx", "JetIndex(Jet_pt_corr, Jet_eta, Jet_phi, Jet_mass_corr, Jet_jetId, muon_p4, tau_p4)")
df = df.Filter("probe_jet_idx != -1")
df = (
    df.Define("leading_jet_pt", "Jet_pt_corr[probe_jet_idx]")
    .Define("leading_jet_eta", "Jet_eta[probe_jet_idx]")
    .Define("leading_jet_phi", "Jet_phi[probe_jet_idx]")
#     # .Define("leading_tau_mass", "Tau_mass[probe_tau_idx]")
#     # .Define("leading_tau_charge", "Tau_charge[probe_tau_idx]")
#     # .Define("leading_tau_decayMode", "Tau_decayMode[probe_tau_idx]")
#     # .Define("leading_tau_idDeepTauVSe", "Tau_idDeepTau2018v2p5VSe[probe_tau_idx]")
...
df = df.Filter("muon_mt < 30")
df = df.Filter("leading_jet_pt > 20")
...
df = df.Filter("vis_mass >= 40 && vis_mass <= 80")

# muon_charge + tau_charge == 0
# df = df.Filter("sig_muon_charge + leading_tau_charge == 0")

if args.type == 'mc':
    df = df.Filter('sig_muon_charge + leading_tau_charge == 0 && tau_gen_match == 5')
...
# df = df.Define("pass_etau_pnet_tight_nobit4","HLT_IsoMu20_eta2p1_PNetTauhPFJet27_Tight_eta2p3_CrossL1==1 && PassETauPNet_nobit4(TrigObj_id, TrigObj_filterBits, TrigObj_pt, TrigObj_l1iso, TrigObj_l1pt, TrigObj_eta, TrigObj_phi, leading_tau_pt, leading_tau_eta, leading_tau_phi, 2)")
# etau check no bit27
# df = df.Define("pass_etau_pnet_loose_nobit27","HLT_IsoMu20_eta2p1_PNetTauhPFJet27_Loose_eta2p3_CrossL1==1 && PassETauPNet_nobit27(TrigObj_id, TrigObj_filterBits, TrigObj_pt, TrigObj_l1iso, TrigObj_l1pt, TrigObj_eta, TrigObj_phi, leading_tau_pt, leading_tau_eta, leading_tau_phi, 0)")
# df = df.Define("pass_etau_pnet_medium_nobit27","HLT_IsoMu20_eta2p1_PNetTauhPFJet27_Medium_eta2p3_CrossL1==1 && PassETauPNet_nobit27(TrigObj_id, TrigObj_filterBits, TrigObj_pt, TrigObj_l1iso, TrigObj_l1pt, TrigObj_eta, TrigObj_phi, leading_tau_pt, leading_tau_eta, leading_tau_phi, 1)")
# df = df.Define("pass_etau_pnet_tight_nobit27","HLT_IsoMu20_eta2p1_PNetTauhPFJet27_Tight_eta2p3_CrossL1==1 && PassETauPNet_nobit27(TrigObj_id, TrigObj_filterBits, TrigObj_pt, TrigObj_l1iso, TrigObj_l1pt, TrigObj_eta, TrigObj_phi, leading_tau_pt, leading_tau_eta, leading_tau_phi, 2)")
# etau check with mutau bit and extra etau selection
...
# ditaujetcRVecU trig_id, cRVecI trig_bits, cRVecF trig_pt, cRVecI trig_l1iso, cRVecF trig_l1pt, cRVecF trig_eta, cRVecF trig_phi, float jet_pt, float jet_eta, float jet_phi
df = df.Define("pass_ditaujet","HLT_IsoMu24_eta2p1_PNetTauhPFJet26_L2NN_eta2p3_CrossL1==1 && PassDiTaujetPNet(TrigObj_id, TrigObj_filterBits, TrigObj_pt, TrigObj_l1iso, TrigObj_l1pt, TrigObj_eta, TrigObj_phi, leading_tau_pt, leading_tau_eta, leading_tau_phi)")\
        .Filter("pass_ditaujet == 1")
df = df.Define("pass_ditaujet_jetleg60","HLT_IsoMu24_eta2p1_PNetTauhPFJet26_L2NN_eta2p3_CrossL1_PFJet60==1 && PassDiTaujetPNetJetLeg(TrigObj_id, TrigObj_filterBits, TrigObj_pt, TrigObj_l1iso, TrigObj_l1pt, TrigObj_eta, TrigObj_phi, leading_jet_pt, leading_jet_eta, leading_jet_phi)")
df = df.Define("pass_ditaujet_jetleg75","HLT_IsoMu24_eta2p1_PNetTauhPFJet26_L2NN_eta2p3_CrossL1_PFJet75==1 && PassDiTaujetPNetJetLeg75(TrigObj_id, TrigObj_filterBits, TrigObj_pt, TrigObj_l1iso, TrigObj_l1pt, TrigObj_eta, TrigObj_phi, leading_jet_pt, leading_jet_eta, leading_jet_phi)")
# singletau
...
skim_branches = [
    ...
    # "HLT_IsoMu24_eta2p1_PNetTauhPFJet26_L2NN_eta2p3_CrossL1", # ditaujet deeptau bit: 3,20
    ...
    "HLT_IsoMu24",
    "weight", # "luminosityBlock",
    "run",
    # "pass_ditau_deeptau", 
    # "pass_ditau_pnet_medium", "pass_ditau_pnet_tight",
    # "pass_mutau_deeptau", 
    # "pass_mutau_pnet_loose", "pass_mutau_pnet_medium", "pass_mutau_pnet_tight",
    # "pass_mutau_deeptau_2024",

    # "pass_etau_deeptau", 
    # "pass_etau_pnet_loose", "pass_etau_pnet_medium", "pass_etau_pnet_tight",
    # etau check
    # "pass_etau_pnet_loose_nobit4", "pass_etau_pnet_medium_nobit4", "pass_etau_pnet_tight_nobit4",
    # "pass_etau_pnet_loose_nobit27", "pass_etau_pnet_medium_nobit27", "pass_etau_pnet_tight_nobit27",
    # "pass_etau_deeptau_withmutaubit", 
    # "pass_etau_pnet_loose_withmutaubit", "pass_etau_pnet_medium_withmutaubit", "pass_etau_pnet_tight_withmutaubit",

    # "pass_ditaujet_deeptau", 
    # "pass_ditaujet_pnet",
    # "pass_ditaujet_pnet_jetleg60", "pass_ditaujet_pnet_jetleg75",
    # single tau 
    # "pass_singletau_deeptau", 
    # "pass_singletau_pnet_loose", "pass_singletau_pnet_medium", "pass_singletau_pnet_tight",
    # "pass_singletau_deeptau_nofilterbit", 
    # "pass_singletau_pnet_loose_nofilterbit", "pass_singletau_pnet_medium_nofilterbit", "pass_singletau_pnet_tight_nofilterbit",

    # "pass_vbfsingletau_pnet",
    # "pass_vbfsingletau_deeptau",
    # "pass_vbfditau_pnet", 
    # "pass_vbfditau_deeptau",
    "pass_ditaujet",
    "pass_ditaujet_jetleg60",
    "pass_ditaujet_jetleg75"
    
    # "pass_mutau_deeptau_nofilterbit", 
    # "pass_mutau_pnet_loose_nofilterbit", "pass_mutau_pnet_medium_nofilterbit", "pass_mutau_pnet_tight_nofilterbit",
    # "pass_vbfsingletau_pnet_nofilterbit", 
    # "pass_vbfsingletau_deeptau_nofilterbit",
]
...
if args.type == "mc":
    for var_mc in ["_nom", "_corrRegrouped_BBEC1_down","_corrRegrouped_BBEC1_up","_corrRegrouped_HF_down","_corrRegrouped_HF_up","_corrRegrouped_EC2_2024_down","_corrRegrouped_EC2_2024_up","_corrRegrouped_EC2_down","_corrRegrouped_EC2_up","_corrRegrouped_RelativeSample_2024_down","_corrRegrouped_RelativeSample_2024_up","_corrRegrouped_BBEC1_2024_down","_corrRegrouped_BBEC1_2024_up","_corrRegrouped_Absolute_down","_corrRegrouped_Absolute_up","_corrRegrouped_FlavorQCD_down","_corrRegrouped_FlavorQCD_up","_corrRegrouped_HF_2024_down","_corrRegrouped_HF_2024_up","_corrRegrouped_RelativeBal_down","_corrRegrouped_RelativeBal_up","_corrRegrouped_Total_down","_corrRegrouped_Total_up","_corrRegrouped_Absolute_2024_down","_corrRegrouped_Absolute_2024_up"]:
        df = (
            df.Define(f"probe_jet_idx{var_mc}", f"JetIndex(Jet_pt{var_mc}, Jet_eta, Jet_phi, Jet_mass{var_mc}, Jet_jetId, muon_p4, tau_p4)")
            .Define(f"leading_jet_pt{var_mc}", f"Jet_pt{var_mc}[probe_jet_idx{var_mc}]")
            .Define(f"leading_jet_eta{var_mc}", f"Jet_eta[probe_jet_idx{var_mc}]")
            .Define(f"leading_jet_phi{var_mc}", f"Jet_phi[probe_jet_idx{var_mc}]")
            .Define(f"pass_ditaujet_jetleg60{var_mc}",f"HLT_IsoMu24_eta2p1_PNetTauhPFJet26_L2NN_eta2p3_CrossL1_PFJet60==1 && PassDiTaujetPNetJetLeg(TrigObj_id, TrigObj_filterBits, TrigObj_pt, TrigObj_l1iso, TrigObj_l1pt, TrigObj_eta, TrigObj_phi, leading_jet_pt{var_mc}, leading_jet_eta{var_mc}, leading_jet_phi{var_mc})")

            # .Define("leading_jet_pt_corr_Total_down", "Jet_pt_corr_Total_down[probe_jet_idx]")
            # .Define("leading_jet_pt_corr_Total_up", "Jet_pt_corr_Total_up[probe_jet_idx]")
        )

        skim_branches.append(f"leading_jet_eta{var_mc}")
        skim_branches.append(f"leading_jet_phi{var_mc}")
        skim_branches.append(f"leading_jet_pt{var_mc}")
        skim_branches.append(f"pass_ditaujet_jetleg60{var_mc}")
    # skim_branches.append("leading_jet_pt_corr_Total_down")
    # skim_branches.append("leading_jet_pt_corr_Total_up")
